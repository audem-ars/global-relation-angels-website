...
const EmployersPage = ({ testimonials, setActivePage }) => {
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            <h1 className="text-white mb-6" style={{
              ...
              lineHeight: '1.1'
            }}>Find Your Perfect Employers</h1>
            
            <p className="text-blue-100 text-xl mb-8" style={{
              fontFamily: typography.body.fontFamily,
              lineHeight: '1.6'
            }}>
              We're a recruitment agency that recruits for roles in Poland, the UK and Europe-wide.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="lg:w-2/3 animate-on-scroll opacity-0 transform translate-y-8 transition-all duration-1000 ease-out" style={{
              ...
              <p className="mb-6" style={{
                ...
                Europe Solutions have grown by offering an efficient and swift recruitment service. We are preferred staffing suppliers with some of the world's biggest companies in the service, engineering, and manufacturing sectors so we have the experience to deliver results.
              </p>
              ...
              <h2 className="mb-6" style={{
                ...
                Through our agencies in Poland and the UK
              </h2>
              ...
              <p className="mb-8" style={{
                ...
                Our bi-lingual consultants smooth the way for a trouble-free placement of staff to help grow your business. We have access to an EU wide network of recruitment job boards and talent. We also have invested in recruitment software supporting all stages of the recruitment process from registration, search and match, CV submission, and interviews through to placement. This allows us to provide a hassle free, fast service to you.
              </p>
              ...
              <p className="mb-6" style={{
                ...
                You can rest assured the complete recruitment cycle will be dealt with by ES so you can concentrate on your core needs. Clients have confidence in us reflecting in the fact over 80% of our existing business is through clients that have partnered with us for over 3 years.
              </p>
              ...
              <a onClick={(e) => setActivePage('permanentPlacement')}
                ...
                <div>
                  ...
                  <p style={{
                    ...
                    fontSize: '0.875rem',
                    opacity: 0.9
                  }}>Long-term staffing solutions</p>
                </div>
              </a>
              
              <a href="/files/recruit-in-europe.pdf" 
                 style={{ 
                   background: 'linear-gradient(145deg, #1e40af 0%, #3b82f6 100%)',
                   borderRadius: '0.75rem',
                   padding: '1.75rem',
                ...
                <div>
                  <h3 style={{
                    ...
                    fontWeight: typography.headings.weights.bold,
                    marginBottom: '0.25rem'
                  }}>Recruit in Europe - PDF</h3>
                  <p style={{
                    fontFamily: typography.body.fontFamily,
                    fontSize: '0.875rem',
                    opacity: 0.9
                  }}>Download our recruitment guide</p>
                </div>
              </a>
              
              <a href="/files/jobs-market-europe.pdf" 
                 style={{ 
                   background: 'linear-gradient(145deg, #1e40af 0%, #3b82f6 100%)',
                   borderRadius: '0.75rem',
                   padding: '1.75rem',
                ...
                <div>
                  <h3 style={{
                    ...
                    fontWeight: typography.headings.weights.bold,
                    marginBottom: '0.25rem'
                  }}>Jobs Market Europe - PDF</h3>
                  <p style={{
                    fontFamily: typography.body.fontFamily,
                    fontSize: '0.875rem',
                    opacity: 0.9
                  }}>Current market insights</p>
                </div>
              </a>
            </div>
          </div>
